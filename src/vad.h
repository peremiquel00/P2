...
typedef enum {ST_MAYBE_VOICE=0, ST_MAYBE_SILENCE=1, ST_SILENCE, ST_VOICE, ST_INIT} VAD_STATE;
...
VAD_DATA *vad_open(float sampling_rate, float alpha0, float alpha1, float alpha2, float tiempo_restante_inicial);
